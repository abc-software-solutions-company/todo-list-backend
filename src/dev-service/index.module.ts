...
import { TaskAttachmentModule } from 'src/database/task-attachment/index.module';
...
@Module({
  imports: [TaskModule, TodolistModule, PoolModule, UserModule, TaskAttachmentModule, AttachmentModule, AuthModule],
